...
ax.scatter(0.5, 0.5, 0.75, color='blue', s=50, marker='D', label='Class Decorators')
ax.scatter(0.5, -0.25, 1, color='blue', s=50, marker='d', label='Function/Method Decorators')
